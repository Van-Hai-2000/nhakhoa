...
class MedicalRecordSearch extends MedicalRecord
{
    ...
    {
        $query = MedicalRecord::find()->where(['<>','status',MedicalRecord::STATUS_DELETE]);
        ...
        $query->andFilterWhere([
            'medical_record.id' => $this->id,
            'user_id' => $this->user_id,
            'medical_record.branch_id' => $this->branch_id,
        ...
        if (isset($this->time_start) && isset($this->time_end)) {
            ...
            $query->andFilterWhere(['>', 'medical_record.created_at', $beginOfDay])
                ->andFilterWhere(['<', 'medical_record.created_at', $endOfDay]);
        }
