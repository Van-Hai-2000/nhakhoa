        ...
        <div class="col-md-2 body_left">
            <ul class="list_time">
                <?php foreach ($medical_record_item as $key => $value): if ($key == 0) {
                    $medical_record_item_child = \common\models\hsba\MedicalRecordItemChildV2::find()->where(['medical_record_item_id' => $value->id])->joinWith(['product', 'userAdmin'])->orderBy('created_at DESC')->all();
                        ...
                        <tr data-key="54">
                            ...
                            <td>
                                ...
                                <button class="pull-right btn btn-primary" data-toggle="modal" data-target=".commission"
                                        onclick="load_commission(<?= $value->medical_record_item_id ?>,<?= $value->id ?>,<?= $value->product_id ?>,2)">
                                    Hoa hồng
                                </button>
                            </td>
                        </tr>
