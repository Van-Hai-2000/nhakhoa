        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="box-append-cat">
                    ...
                    <div id="list_thu_thuat_kham_benh"></div>
                </div>
                <a class="add-select-cat" onclick="them_thu_thuat_kham_benh('list_thu_thuat_kham_benh','dstt','<?= \yii\helpers\Url::to(['load-html-kham-benh']) ?>')"><i class="glyphicon glyphicon-plus"></i> Thêm thủ thuật</a>
