...
<script type="text/javascript">
    <?php if($model->ckedit_desc) { ?>
        jQuery(document).ready(function () {
            CKEDITOR.replace("medicinecategory-description", {
                height: 400,
    ...
    <?php } ?>
    jQuery(document).ready(function () {
            $('#medicinecategory-ckedit_desc').on("click", function () {
                if (this.checked) {
                    CKEDITOR.replace("medicinecategory-description", {
                        height: 400,
                        language: '<?php echo Yii::$app->language ?>'
                    ...
                    var a = CKEDITOR.instances['medicinecategory-description'];
                    if (a) {
                        a.destroy(true);
                    }
        ...
        <div class="row">
            ...
            <div class="x_panel">
                ...
                <div class="form-group">
                    <?= Html::submitButton($model->isNewRecord ? 'Xác nhận' : 'Cập nhật', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
                </div>
            </div>
            <?php ActiveForm::end(); ?>
        </div>
