...
<div class="x_panel">
    <div class="x_title">
        <h2><i class="fa fa-bars"></i> Hồ sơ khách hàng: <?= $model['username'] ?> </h2>
    ...
    <div class="x_content" style="display: block;">
        <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
            <li class="nav-item active">
                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true" aria-expanded="true">Thông tin cơ bản</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Khám và điều trị</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Đơn thuốc</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="libraryimg-tab" data-toggle="tab" href="#libraryimg" role="tab" aria-controls="libraryimg" aria-selected="false">Thư viện ảnh</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="datxuong-tab" data-toggle="tab" href="#datxuong" role="tab" aria-controls="datxuong" aria-selected="false">Đặt xưởng</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="lichhen-tab" data-toggle="tab" href="#lichhen" role="tab" aria-controls="lichhen" aria-selected="false">Lịch hẹn</a>
            </li>
            <li class="nav-item">
                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <li><div> <a class="btn btn-primary" href="<?= Url::to(['/user/user/update','id'=>$model['id']])?>"> Sửa thông tin</a> </div></li>
                        ...
                        <div class="col-lg-6 ">
                            <div class="row">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <div class="d-flex info-customer">
                                        <?php $sex = \common\models\user\User::getSex(); ?>
                                        <div class=" info-customer-title">Giới tính:</div>
                                        <div class="info-customer-content"><?php echo $model['sex'] ? $sex[$model['sex']] : '' ?></div>
                                    </div>
                                    <div class="d-flex info-customer">
                                    ...
                                    <div class="d-flex info-customer">
                                        <div class=" info-customer-title">Ngày sinh:</div>
                                        <div class="info-customer-content"><?php echo date('d-m-Y', $model['birthday']); ?></div>
                                    </div>
                                    <div class="d-flex info-customer">
                                    ...
                                    <div class="d-flex info-customer">
                                        <?php $data = \common\models\user\User::getTypeIntroduce(); ?>
                                        <div class=" info-customer-title">Nguồn khách hàng:</div>
                                        <div class="info-customer-content"><?php echo isset($model['type_introduce']) && $model['type_introduce'] != 0 ? $data[$model['type_introduce']] : '' ?></div>
                                    </div>
                                    <div class="d-flex info-customer">
                                        <div class=" info-customer-title">Nhóm khuyến mãi:</div>
                                        <div class="info-customer-content"></div>
                                    </div>
                                    <div class="d-flex info-customer">
                                        <div class=" info-customer-title">Nhóm khách hàng:</div>
                                        <div class="info-customer-content"></div>
                                    </div>
                                    <div class="d-flex info-customer">
                                        <div class=" info-customer-title">Địa chỉ:</div>
                                        <div class="info-customer-content">
                                            <?php
                                            if ($model['address'] && $address == '') {
                                                echo $model['address'];
                                            } else if (!$model['address'] && $address) {
                                                echo $address;
                                            } else if($model['address'] && $address)
                                            {
                                    ...
                                    <div class="d-flex info-customer">
                                        <div class=" info-customer-title">Lý do đến khám:</div>
                                        <div class="info-customer-content"></div>
                                    </div>
                                    <div class="d-flex info-customer">
                                        <div class=" info-customer-title">Bác sĩ chính:</div>
                                        <div class="info-customer-content"></div>
                                    </div>
                                    <div class="d-flex info-customer">
                                        <div class=" info-customer-title">Nhân viên phụ trách:</div>
                                        <div class="info-customer-content"></div>
                                    </div>
<!--                                    <div class="main-form-description">-->
<!--                                        <div class="title-box">Ghi chú</div>-->
<!--                                        <textarea name="" class="text-area-form">-->
<!---->
<!--                                    </textarea>-->
<!--                                    </div>-->
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="title-box">Người thân</div>
                            <div class="d-flex info-customer">
                                <div class=" info-customer-title">Họ và tên:</div>
                                <div class="info-customer-content"></div>
                            </div>
                            <div class="d-flex info-customer">
                                <div class=" info-customer-title">Quan hệ:</div>
                                <div class="info-customer-content"></div>
                            </div>
                            <div class="d-flex info-customer">
                                <div class=" info-customer-title">Số điện thoại:</div>
                                        ...
                                        <div class="panel-body">
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="column-title">Tổng phải thanh toán ( Đã bao gồm VAT 10% )</th>
                                                ...
                                                if(isset($medical_record) && $medical_record){
                                                    foreach ($medical_record as $value){
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= $value['phone'] ?></td>
                                                            <td><?= number_format($value['total_money'] - $value['sale_money']) ?></td>
                                                            <td><?= number_format($value['money']) ?></td>
                                                            <td style="color:#FF0000;"><?= number_format($value['total_money'] - $value['money'] - $value['sale_money']) ?></td>
                                                            <td><a class="btn btn-success" href="<?= \yii\helpers\Url::to(['/user/medical-record/add', 'id' => $value['id']])?>">Xem chi tiết</a> </td>
                                                        </tr>
                                                    <?php }}?>
                                                </tbody>
                                            </table>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline jambo_table bulk_action">
                                ...
                                <tr class="even pointer">
                                    <td><?= $value->medical_record_id ?></td>
                                    <td><?= isset($value->created_at) && $value->created_at ? date('d-m-Y',$value->created_at)  : ''?></td>
                                    <td><?= isset($value->created_at) && $value->created_at ?date('H:i:s',$value->created_at) :"" ?></td>
                                    ...
                                    <td><?= isset($value->medicine->price) && $value->medicine->price ? number_format($value->medicine->price) : "" ?></td>
                                    <td><?= isset($value->quantity) && $value->quantity ? $value->quantity : "" ?></td>
                                    <td><?= isset($value->medicine) && $value->medicine ? number_format($value->quantity * $value->medicine->price) : "" ?></td>
                                    </td>
                                </tr>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            ...
                            <div class="col-md-55">
                                <div class="thumbnail">
                                    <div class="image view view-first" style="height: 100%;">
                                        <a href="#" onclick="zoom_image(this)" data-toggle="modal" data-target=".zoom_image" data-src="<?= \common\components\ClaHost::getImageHost().$value['path'].$value['name'] ?>"><img class="medical_record_image" src="<?= \common\components\ClaHost::getImageHost().$value['path'].$value['name'] ?>" alt=""></a>
