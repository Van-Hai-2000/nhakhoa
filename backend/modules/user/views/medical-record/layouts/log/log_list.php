            ...
            <?php foreach ($logs as $log): ?>
                <div class="row timeline-movement">
                    <div class="col-md-12">
                        ...
                        <h4 class="label_action"><?= isset(\common\components\ClaLog::getTableName()[$log->model]) && \common\components\ClaLog::getTableName()[$log->model] ? \common\components\ClaLog::getTableName()[$log->model] : '' ?>
                            - <?= $log->action ?></h4>
                    </div>
